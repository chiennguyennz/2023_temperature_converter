...
class HistoryExport:
    ...
    def __init__(self, partner, calc_list):
        ...
        # area depending on whether all for only some calculations
        # are shown
        ...
        self.all_calcs_label = Label(self.history_frame,
                                     text=calc_string_text,  # Display the calculation string
